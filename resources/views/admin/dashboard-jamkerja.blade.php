        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <input type="text" name="nama_shift" class="form-control" id="inputEmail4">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="inputEmail4">Waktu Mulai</label>
              <input type="datetime-local" name="waktu_mulai" class="form-control" id="inputEmail4">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-12">
              <label for="inputEmail4">Waktu Selesai</label>
              <input type="datetime-local" name="waktu_akhir" class="form-control" id="inputEmail4">
            </div>
          </div>
        </div>
        ...
        <form action="{{route('jamKerja.update', $dp->id)}}" method="post">
          ...
          <div class="modal-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-12">
                <label for="inputEmail4">Waktu Mulai</label>
                <input type="datetime-local" name="waktu_mulai" value="{{date('Y-m-d\TH:i', strtotime($dp->waktu_mulai))}}" class="form-control" id="inputEmail4">
              </div>
              <div class="form-group col-md-12">
                <label for="inputEmail4">Waktu Selesai</label>
                <input type="datetime-local" name="waktu_akhir" value="{{date('Y-m-d\TH:i', strtotime($dp->waktu_akhir))}}" class="form-control" id="inputEmail4">
              </div>
            </div>
          </div>
          <div class="modal-footer">
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Jam Kerja Karyawan</h1>

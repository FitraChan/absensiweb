...
// lupa absen masuk
          if($get_id->jam_pulang != null){
            ...
            //  'jam_kerja_id' => $work_time['jam_kerja_id'],
             ...
             $request['jam_kerja_id'] = $work_time['jam_kerja_id'];

              $request['ot_in'] = $work_time['ot_in'];

						$cek = $absensi->create($request->all());
				...
				//	$request['jam_pulang'] = date('Y-m-d H:i:s', strtotime($request->waktu));
